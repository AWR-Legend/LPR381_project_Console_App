...
namespace LPR381_project.Branch_and_Bound
{
    internal class Branch_Bound
    {
        ...
        //    BranchAndBound(new int[2], 0, constraint1, constraint1RHS, constraint2, constraint2RHS);

        //    Console.WriteLine("Maximum Z: " + MaxZ);
        //    Console.WriteLine("Best Solution: x1 = " + BestSolution[0] + ", x2 = " + BestSolution[1]);
        //}
